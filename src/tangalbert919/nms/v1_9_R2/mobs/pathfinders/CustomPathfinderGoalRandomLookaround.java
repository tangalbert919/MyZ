...
public class CustomPathfinderGoalRandomLookaround extends PathfinderGoal {
    ...
    public boolean a() {
        return this.creature.getRandom().nextFloat() < 0.02F;
    }
    ...
    public void c() {
        double d1 = 6.283185307179586D * this.creature.getRandom().nextDouble();

        this.xOffset = Math.cos(d1);
        this.zOffset = Math.sin(d1);
        this.lookAway = 20 + this.creature.getRandom().nextInt(20);
    }

    public void e() {
        --this.lookAway;
        this.creature.getControllerLook().a(this.creature.locX + this.xOffset, this.creature.locY + (double) this.creature.getHeadHeight(), this.creature.locZ + this.zOffset, 10.0F, (float) this.creature.N());
    }
}