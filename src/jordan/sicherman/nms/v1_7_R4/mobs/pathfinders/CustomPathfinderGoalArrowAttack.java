...
public class CustomPathfinderGoalArrowAttack extends PathfinderGoal {
    ...
    public boolean b() {
        return this.a() || !this.insentientCreature.getNavigation().g();
    }
    ...
    public void e() {
        double distance = this.insentientCreature.e(this.target.locX, this.target.boundingBox.b, this.target.locZ);
