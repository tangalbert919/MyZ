...
public class EngineerManager extends SimpleCommandExecutor {
    ...
    public void execute(CommandSender sender, String[] args, CommandHandler handler) {
        if (!this.willExecute(sender)) {
            ...
            ManagerManager.setManager((Player) sender, true, ManagerManager.ManagerType.ENGINEER);
            sender.sendMessage(LocaleMessage.MANAGING_ENGINEER.toString(sender));
        }
    }
