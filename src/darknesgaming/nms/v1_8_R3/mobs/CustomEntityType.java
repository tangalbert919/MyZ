        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (biomeBase != BiomeBase.HELL) {
                ...
                if (!generalExcluded.contains(biomeBase.ah)) {
                    if (CustomEntityType.PIG_ZOMBIE.meta.enabled && !list1.contains(biomeBase.ah) && !((CustomEntityType.DefaultCache) CustomEntityType.cache.get(biomeBase)).at.contains(CustomEntityType.PIG_ZOMBIE.meta.toBiomeMeta())) {
                    ...
                    if (CustomEntityType.GUARD.meta.enabled && !list2.contains(biomeBase.ah) && !((CustomEntityType.DefaultCache) CustomEntityType.cache.get(biomeBase)).at.contains(CustomEntityType.GUARD.meta.toBiomeMeta())) {
                        list3 = (List) NMS.getDeclaredField(biomeBase, CustomEntityType.DefaultCache.keys[0]);
                        if (list3 != null) {
                ...
                if (CustomEntityType.GIANT_ZOMBIE.meta.enabled && ((List) ConfigEntries.GIANT_INCLUDES.getValue()).contains(biomeBase.ah) && !((CustomEntityType.DefaultCache) CustomEntityType.cache.get(biomeBase)).at.contains(CustomEntityType.GIANT_ZOMBIE.meta.toBiomeMeta())) {
                    list3 = (List) NMS.getDeclaredField(biomeBase, CustomEntityType.DefaultCache.keys[0]);
                    if (list3 != null) {
