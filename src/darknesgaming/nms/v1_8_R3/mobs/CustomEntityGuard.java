...
public class CustomEntityGuard extends EntitySkeleton implements SmartEntity {
    ...
    protected void a(DifficultyDamageScaler difficultydamagescaler) {
        switch (CustomEntityGuard.SyntheticClass_1.$SwitchMap$darknesgaming$nms$v1_8_R3$mobs$CustomEntityGuard$GuardType[this.type.ordinal()]) {
        case 1:
    ...
    static class SyntheticClass_1 {
        ...
        static final int[] $SwitchMap$darknesgaming$nms$v1_8_R3$mobs$CustomEntityGuard$GuardType = new int[CustomEntityGuard.GuardType.values().length];

        static {
            try {
                CustomEntityGuard.SyntheticClass_1.$SwitchMap$darknesgaming$nms$v1_8_R3$mobs$CustomEntityGuard$GuardType[CustomEntityGuard.GuardType.MELEE.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror) {
                ;
            }

            try {
                CustomEntityGuard.SyntheticClass_1.$SwitchMap$darknesgaming$nms$v1_8_R3$mobs$CustomEntityGuard$GuardType[CustomEntityGuard.GuardType.RANGED.ordinal()] = 2;
