...
public class CustomEntityZombie extends EntityZombie implements SmartEntity {
    ...
    protected float ch() {
        return (float) ((double) super.ch() * ((Double) ConfigEntries.ZOMBIE_JUMP_MULTIPLIER.getValue()).doubleValue());
    }
    ...
    protected void a(DifficultyDamageScaler difficultydamagescaler) {
        ...
        case 1:
            ...
            this.setEquipment(EnumItemSlot.CHEST, new ItemStack(Items.CHAINMAIL_CHESTPLATE));
            this.setEquipment(EnumItemSlot.HEAD, new ItemStack(Items.CHAINMAIL_HELMET));
            break;

        case 2:
            this.setEquipment(EnumItemSlot.FEET, new ItemStack(Items.GOLDEN_BOOTS));
            this.setEquipment(EnumItemSlot.LEGS, new ItemStack(Items.GOLDEN_LEGGINGS));
            this.setEquipment(EnumItemSlot.CHEST, new ItemStack(Items.GOLDEN_CHESTPLATE));
            this.setEquipment(EnumItemSlot.HEAD, new ItemStack(Items.GOLDEN_HELMET));
            break;

        case 3:
            this.setEquipment(EnumItemSlot.FEET, new ItemStack(Items.IRON_BOOTS));
            this.setEquipment(EnumItemSlot.LEGS, new ItemStack(Items.IRON_LEGGINGS));
            this.setEquipment(EnumItemSlot.CHEST, new ItemStack(Items.IRON_CHESTPLATE));
            this.setEquipment(EnumItemSlot.HEAD, new ItemStack(Items.IRON_HELMET));
            break;

        case 4:
            this.setEquipment(EnumItemSlot.FEET, new ItemStack(Items.LEATHER_BOOTS));
            this.setEquipment(EnumItemSlot.LEGS, new ItemStack(Items.LEATHER_LEGGINGS));
            this.setEquipment(EnumItemSlot.CHEST, new ItemStack(Items.LEATHER_CHESTPLATE));
            this.setEquipment(EnumItemSlot.HEAD, new ItemStack(Items.LEATHER_HELMET));
        }
