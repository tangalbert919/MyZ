...
import darknesgaming.nms.v1_9_R1.mobs.pathfinders.*;
...
public class CustomEntityZombie extends EntityZombie implements SmartEntity {
    ...
    protected void a(DifficultyDamageScaler difficultydamagescaler) {
        switch (CustomEntityZombie.SyntheticClass_1.$SwitchMap$jordan$sicherman$nms$v1_9_R1$mobs$CustomEntityZombie$ZombieType[this.type.ordinal()]) {
        case 1:
    ...
    static class SyntheticClass_1 {
        ...
        static final int[] $SwitchMap$jordan$sicherman$nms$v1_9_R1$mobs$CustomEntityZombie$ZombieType = new int[CustomEntityZombie.ZombieType.values().length];

        static {
            try {
                CustomEntityZombie.SyntheticClass_1.$SwitchMap$jordan$sicherman$nms$v1_9_R1$mobs$CustomEntityZombie$ZombieType[CustomEntityZombie.ZombieType.CHAIN.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror) {
                ;
            }

            try {
                CustomEntityZombie.SyntheticClass_1.$SwitchMap$jordan$sicherman$nms$v1_9_R1$mobs$CustomEntityZombie$ZombieType[CustomEntityZombie.ZombieType.GOLD.ordinal()] = 2;
            } catch (NoSuchFieldError nosuchfielderror1) {
                ;
            }

            try {
                CustomEntityZombie.SyntheticClass_1.$SwitchMap$jordan$sicherman$nms$v1_9_R1$mobs$CustomEntityZombie$ZombieType[CustomEntityZombie.ZombieType.IRON.ordinal()] = 3;
            } catch (NoSuchFieldError nosuchfielderror2) {
                ;
            }

            try {
                CustomEntityZombie.SyntheticClass_1.$SwitchMap$jordan$sicherman$nms$v1_9_R1$mobs$CustomEntityZombie$ZombieType[CustomEntityZombie.ZombieType.LEATHER.ordinal()] = 4;
