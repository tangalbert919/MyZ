...
public class CustomPathfinderGoalMeleeAttack extends PathfinderGoal {
    ...
    public boolean b() {
        ...
        return target == null ? false : (!target.isAlive() ? false : (!this.bypassVision ? !this.creature.getNavigation().n() : this.creature.f(new BlockPosition(target))));
    }
    ...
    public void e() {
        ...
        if (target != null && (target.hasEffect(MobEffects.WITHER) || target.hasEffect(MobEffects.INVISIBILITY))) {
            ...
            --this.delay;
            if ((this.bypassVision || this.creature.getEntitySenses().a(target)) && this.delay <= 0 && (this.targetX == 0.0D && this.targetY == 0.0D && this.targetZ == 0.0D || target.e(this.targetX, this.targetY, this.targetZ) >= 1.0D || this.creature.getRandom().nextFloat() < 0.05F)) {
                this.targetX = target.locX;
                this.targetY = target.getBoundingBox().b;
                this.targetZ = target.locZ;
                this.delay = 4 + this.creature.getRandom().nextInt(7);
                if (distance > 1024.0D) {
                    this.delay += 10;
