...
import darknesgaming.nms.v1_9_R2.mobs.pathfinders.CustomPathfinderGoalArrowAttack;
import darknesgaming.nms.v1_9_R2.mobs.pathfinders.CustomPathfinderGoalHurtByTarget;
import darknesgaming.nms.v1_9_R2.mobs.pathfinders.CustomPathfinderGoalLookAtPlayer;
import darknesgaming.nms.v1_9_R2.mobs.pathfinders.CustomPathfinderGoalMeleeAttack;
import darknesgaming.nms.v1_9_R2.mobs.pathfinders.CustomPathfinderGoalMoveToLocation;
import darknesgaming.nms.v1_9_R2.mobs.pathfinders.CustomPathfinderGoalNearestAttackableTarget;
import darknesgaming.nms.v1_9_R2.mobs.pathfinders.CustomPathfinderGoalRandomLookaround;
import darknesgaming.nms.v1_9_R2.mobs.pathfinders.CustomPathfinderGoalRandomStroll;
...
public class CustomEntityGuard extends EntitySkeleton implements SmartEntity {
    ...
    protected void a(DifficultyDamageScaler difficultydamagescaler) {
        switch (CustomEntityGuard.SyntheticClass_1.$SwitchMap$jordan$sicherman$nms$v1_9_R2$mobs$CustomEntityGuard$GuardType[this.type.ordinal()]) {
        case 1:
    ...
    static class SyntheticClass_1 {
        ...
        static final int[] $SwitchMap$jordan$sicherman$nms$v1_9_R2$mobs$CustomEntityGuard$GuardType = new int[CustomEntityGuard.GuardType.values().length];

        static {
            try {
                CustomEntityGuard.SyntheticClass_1.$SwitchMap$jordan$sicherman$nms$v1_9_R2$mobs$CustomEntityGuard$GuardType[CustomEntityGuard.GuardType.MELEE.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror) {
                ;
            }

            try {
                CustomEntityGuard.SyntheticClass_1.$SwitchMap$jordan$sicherman$nms$v1_9_R2$mobs$CustomEntityGuard$GuardType[CustomEntityGuard.GuardType.RANGED.ordinal()] = 2;
