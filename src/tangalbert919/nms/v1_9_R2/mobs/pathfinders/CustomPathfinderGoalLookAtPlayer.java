...
public class CustomPathfinderGoalLookAtPlayer extends PathfinderGoal {
    ...
    public boolean a() {
        ...
        if (this.target == null) {
            if (this.classToLookAt == EntityHuman.class) {
                if ((double) this.creature.getRandom().nextFloat() <= 0.5D) {
    ...
    public void c() {
        this.lookAway = 40 + this.creature.getRandom().nextInt(40);
    }
    ...
    public void e() {
        this.creature.getControllerLook().a(this.target.locX, this.target.locY + (double) this.target.getHeadHeight(), this.target.locZ, 10.0F, (float) this.creature.N());
        --this.lookAway;
    }
}
